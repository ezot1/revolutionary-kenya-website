  ...
  <section className="relative h-[85vh] min-h-[600px] flex items-center justify-center overflow-hidden">
    ...
    <div className="relative z-10 container mx-auto px-4 text-center max-w-4xl">
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-center">
        <Link
          to="/contact"
          className="inline-flex items-center justify-center px-8 py-3 rounded-md bg-primary text-primary-foreground font-bold text-lg hover:bg-primary/90 transition"
        >
          Join Us
        </Link>
        <Link
          to="/program"
          className="inline-flex items-center justify-center px-8 py-3 rounded-md border-2 border-foreground text-foreground font-bold text-lg hover:bg-foreground/10 transition"
        >
          Read Our Program
        </Link>
      </div>
    ...
    <div className="container mx-auto px-4">
      ...
      <div className="grid md:grid-cols-3 gap-6">
        {[
          ...
          <div key={c.title} className="bg-card border border-border rounded-lg p-6 hover:border-primary/50 transition">
  ...
  <section className="py-20 bg-secondary">
    <div className="container mx-auto px-4">
      ...
      <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto">
        <div className="bg-card border-l-4 border-l-primary border border-border rounded-lg p-6">
          ...
          <div className="flex flex-wrap gap-2 mb-4">
            {["🌍 Africa", "🌍 Europe", "🌎 Latin America", "🌏 Asia", "🌍 Middle East", "🌎 North America"].map((r) => (
              <span key={r} className="text-xs bg-secondary px-3 py-1 rounded-full text-muted-foreground border border-border">
                {r}
              </span>
            ))}
          </div>
